...
helpers.paginate = (pagination, options) => {
    ...
    var leftText = '<i class="fas fa-chevron-left"></i>';
    var rightText = '<i class="fas fa-chevron-right"></i>';
    var firstText = '<i class="fas fa-chevron-double-left"></i>';
    var lastText = '<i class="fas fa-chevron-double-right"></i>';
    ...
    // ========= First Button ===============
    if (page === 1) {
        template = template + '<li class="disabled"><a href="?page=1' + queryParams + '">' + firstText + '</a></li>';
    } else {
        template = template + '<li><a href="?page=1' + queryParams + '">' + firstText + '</a></li>';
    }
    ...
    // ========= Last Button ===============
    if (page === pageCount) {
        template = template + '<li class="disabled"><a href="?page=' + pageCount + queryParams + '">' + lastText + '</a></li>';
    } else {
        template = template + '<li><a href="?page=' + pageCount + queryParams + '">' + lastText + '</a></li>';
    }
